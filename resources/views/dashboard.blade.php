        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ route('banner') }}" class="nav-link active">
...
<script src="https://raw.githubusercontent.com/raphaelbeckmann/summernote/patch-1/plugin/summernote-ext-resized-data-image.js"></script>
...
<script>
$(document).on('change','#righ',function(e){
    $('#btn_test').css('left',$(this).val()+'%');
})
$(document).on('change','#bot',function(e){
    $('#btn_test').css('bottom',$(this).val()+'%');
    console.log($('#btn_test').html());
})
...
rangeSlider();
$(document).on('click','.data_id',function(e){
    var id = $(this).attr('id');
    $('#del').attr('href','product-manager/delete/'+id)
});
$(document).ready(function() {
    $('#summernote').summernote({
      ...
      toolbar: [
        ...
        ['view', ['fullscreen', 'codeview', 'help','resizedDataImage']],
      ],
      popover: {
        image: [
